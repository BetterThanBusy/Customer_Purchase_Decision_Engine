...
![PR-AUC 0.57](https://img.shields.io/badge/test%20PR--AUC-0.571-51051E)
![Lift 3.0x](https://img.shields.io/badge/top%2010%25%20lift-3.0x-FF4500)
![Python 3.10+](https://img.shields.io/badge/python-3.10%2B-043C4D)
![License MIT](https://img.shields.io/badge/license-MIT-black)

**Full write-up: [Your churn model is fine. Your marketing strategy is the problem.](docs/substack_post.md)**
...
│   └── video_tables.xlsx     presentation workbook, live break-even sheet
├── docs/
│   ├── substack_post.md      the long-form write-up
│   ├── video_script.md       10-minute walkthrough script
│   └── short_scripts.md      2-minute and 60-second cuts
├── LICENSE
└── README.md
```
